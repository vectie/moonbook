...
- Rabbita now has a real operator/dashboard surface and can consume rebuild-triggered workspace state refresh, but it is still not a fully integrated live editor/operator product
